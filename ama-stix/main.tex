...
\title{Transparent Live Migration of Container Deployments in Userspace\protect\thanks{This work has been partially funded by a research collaboration grant \textit{"Beca de col·laboraci\'o en departaments universitaris - Curs 2019-2020"} by the \textit{"Ministerio de eduaci\'on y formaci\'on profesional"}.}}

\author[1]{Carlos Segarra*}

\author[1,2]{Jordi Guitart}

\authormark{Carlos Segarra \textsc{et al}}


\address[1]{\orgdiv{Computer Architecture Department}, \orgname{Technical University of Catalonia}, \orgaddress{\state{Barcelona}, \country{Spain}}}

\address[2]{\orgdiv{Autonomic Systems and eBusiness Platforms}, \orgname{Barcelona Supercomputing Center}, \orgaddress{\state{Barcelona}, \country{Spain}}}

\corres{*Corresponding author name, Corresponding address. \email{carlos.segarra@estudiant.upc.edu}}
