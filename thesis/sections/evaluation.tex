...
\section{Scalability with the Container's Memory Size} \label{sec:eval-memory}
...
When compared to native migration, our system does not rely on files written to disk, neither duplicates memory allocation.
