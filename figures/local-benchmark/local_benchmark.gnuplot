...
set output 'local_benchmark.eps'
...
# Plot 0
set title "{/Bold File-Based Migration}" offset 0,-0.5
...
plot 'local_benchmark_processed.dat' \
...
# Plot 1
set title "{/Bold Diskless Migration}"
unset ylabel
unset xlabel
set ytics format ""
plot 'local_benchmark_processed.dat' \
...
!epstopdf 'local_benchmark.eps'
!rm 'local_benchmark.eps'
